...
// Clase DAO para gestionar operaciones relacionadas con los docentes en la base de datos
public class GestionarDocente {

    // Consulta SQL para obtener datos de docentes, incluyendo preguntas y respuestas
    ...
    // Método para obtener la lista de docentes con sus datos
    public List<Usuario> obtenerDatosDocentes() {
        ...
        try (Connection connection = new Conexion().conectar();
            ...
            while (rs.next()) {
                ...
                // Establecer valores del docente en el objeto Usuario
            ...
            // Tratar la excepción adecuadamente, ya sea registrándola o lanzándola de nuevo
            e.printStackTrace();
        }
    ...
    // Método para actualizar la información completa de un docente en la base de datos
