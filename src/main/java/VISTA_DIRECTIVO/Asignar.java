...
public class Asignar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rSLabelTextIcon2.setText("Asignar");
        rSLabelTextIcon2.setFont(new java.awt.Font("Roboto Bold", 1, 48)); // NOI18N
        rSLabelTextIcon2.setIcons(rojeru_san.efectos.ValoresEnum.ICONS.CREATE_NEW_FOLDER);
    ...
    private void tab1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tab1ActionPerformed
        Asignar_Area asiAre=new Asignar_Area();
        CAsignarArea controlador=new CAsignarArea(asiAre);
        //instanciar controlador de administrar docente
        Principal.removeAll();
        Principal.setLayout(new BorderLayout());
        Principal.add(asiAre.getContentPane(),BorderLayout.CENTER);
    ...
    private void tab2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tab2ActionPerformed
        Asignar_Tutor asiTut=new Asignar_Tutor();
        CAsignarTutoria controlador=new CAsignarTutoria(asiTut);
        //instanciar controlador de administrar docente
        Principal.removeAll();
        Principal.setLayout(new BorderLayout());
        Principal.add(asiTut.getContentPane(),BorderLayout.CENTER);
        Principal.revalidate();
        Principal.repaint();
